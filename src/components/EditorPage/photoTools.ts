...
export const subFilters = {
  ...
  face: [
    ...
    {
      id: 11,
      name: "Увеличить расстояние глаз",
      shape_type: "11",
      img: filter,
      numFilters: 0,
      rangeType: true,
